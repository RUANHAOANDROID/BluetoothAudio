...
public class MainActivity extends Activity implements AnyChatBaseEvent {
	...
	private String mStrIP = "192.168.28.236";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		AnyChatCoreSDK.mAudioHelper.SetContext(getApplicationContext());
		check();
		// 注册广播
	...
	private void openSco() {
		mAudioManager = (AudioManager) MainActivity.this
	...
	private void closeSco(){
		mAudioManager = (AudioManager) MainActivity.this
				.getSystemService(Context.AUDIO_SERVICE);
		if (mAudioManager.isBluetoothScoAvailableOffCall() && mAudioManager.isBluetoothScoOn()) {// 蓝牙可用
	...
	private void InitLayout() {
		...
		blueTooth = (Button) this.findViewById(R.id.buleTooth);
		...
		mBtnStart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (checkInputData()) {
					 ...
					 * 详情请参考：http://bbs.anychat.cn
					 * /forum.php?mod=viewthread&tid=2211&highlight=%C7%A9%C3%FB
					 */
		...
		blueTooth.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (mAudioManager.isBluetoothScoAvailableOffCall()) {// 蓝牙可用
					Log.e("AudioRecoder", "蓝牙可用----line == 201");
					// mAudioManager.setMode(AudioManager.MODE_IN_COMMUNICATION);
					// mAudioManager.setSpeakerphoneOn(true);
					mAudioManager.setBluetoothScoOn(true);
					mAudioManager.startBluetoothSco();
					Log.e("AudioRecoder", "开启蓝牙Sco----line == 206");
					Toast.makeText(MainActivity.this, "蓝牙开启了",
							Toast.LENGTH_SHORT).show();
					// isUsingBluetooth = true;
					// AnyChatCoreSDK.mAudioHelper.SwitchPlayMode(AnyChatAudioHelper.PLAY_MODE_RECEIVER);
					AnyChatCoreSDK.mAudioHelper
							.setMode(AnyChatAudioHelper.PLAY_MODE_RECEIVER);
				}
			}
		});
	}
	...
	private void readLoginDate() {
		...
		mStrIP = preferences.getString("UserIP", "192.168.28.236");
	...
	protected void onDestroy() {
		...
		// unregisterReceiver(bluetoothDis);
		// unregisterReceiver(bluetoothConn);
		unregisterReceiver(bluetoothHeadset);
		super.onDestroy();
	}
	 ...
	 * 中途连接或者断开蓝牙耳机
	 */
	private BroadcastReceiver bluetoothHeadset = new BroadcastReceiver() {
	...
	private BroadcastReceiver bluetoothReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (AudioManager.SCO_AUDIO_STATE_CONNECTED == state) {
				...
				AnyChatCoreSDK.mAudioHelper
				.setMode(AnyChatAudioHelper.PLAY_MODE_SPEAKER);
			}
		}
	};
	...
	public void registerBoradcastReceiver() {
		...
		registerReceiver(bluetoothHeadset, new IntentFilter(
